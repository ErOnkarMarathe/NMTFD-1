...
The code computes the unsteady, incompressible Navier–Stokes equations on a unit square domain in MATLAB.  
All major physical mechanisms—advection, diffusion, and pressure correction—are handled using explicit finite difference schemes.
