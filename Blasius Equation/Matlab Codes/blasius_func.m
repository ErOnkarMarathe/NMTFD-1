function [rf,rg,rh, y_plot, r_eta] = blasius_func(dy, x, Re)

    %Codes taken from: https://de.mathworks.com/matlabcentral/fileexchange/102189-solving-blasius-equation-using-rk-4-numerical-method
    ...
    %dy = 0.00005; x = 0.0005; %for ex1 => (0.000005,0.0005, 10000)
    %dy = 0.005; x = 0.5;      %for ex2 => (0.005, 0.5, 10000) 
    %Re = 10000;
    delta=5/sqrt(Re);
    y = 0:dy:2*delta;
    %here======================
    ...
    rf = F(:,1); rg = F(:,2); rh = F(:,3); y_plot=y; r_eta = eta';
end